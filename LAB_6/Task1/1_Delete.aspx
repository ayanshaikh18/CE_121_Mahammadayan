...
<body>
    <form id="form1" runat="server">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/1_Edit.aspx">Edit</asp:HyperLink>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <table>
                ...
                <tr>
                    <td colspan="2" style="text-align:center">
                        <br />
                        <asp:Button ID="Delete1" runat="server" Text="Delete" OnClick="Delete_Click" />
                        <br />
                        <br />
